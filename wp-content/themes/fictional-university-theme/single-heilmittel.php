...
<div class="container container--narrow page-section">
  ...
  <div>
    <h2 class="headline headline--mainBlue"><?php the_title(); ?><strong> Erfahrungsberichte</strong></h2>
  </div>
  ...
  <div>
    <h2 class="headline headline--mainBlue">Schreibe deinen<strong> Erfahrungsbericht</strong></h2>
  </div>
